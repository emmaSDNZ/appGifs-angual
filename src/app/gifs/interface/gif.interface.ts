// To parse this data:
//
//   import { Convert, SearchGifsType } from "./file";
//
//   const searchGifsType = Convert.toSearchGifsType(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchGifsType {
    data:       Gif[];
...
export class Convert {
    public static toSearchGifsType(json: string): SearchGifsType {
        return cast(JSON.parse(json), r("SearchGifsType"));
    }

    public static searchGifsTypeToJson(value: SearchGifsType): string {
        return JSON.stringify(uncast(value, r("SearchGifsType")), null, 2);
    }
}
